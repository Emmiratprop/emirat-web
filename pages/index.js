...
export default function Home({posts}) {
  ...
  return (
    <MainLayout title='EMIRAT PROPIEDADES'> 
      <Banner />
      <Menu />
      <Grid container paddingLeft={{xs:1.5, sm:10}} paddingRight={{xs:1.5, sm:10}} direction='column' width='100%' height={{xs:'400vh', sm:'350vh'}} alignItems='center' justifyContent='space-around' mt={{xs:10, sm:20}}>
